            ...
            <tbody>
                @foreach ($carrito_total as $carrito)
                    ...
                    <tr>
                        ...
                        <td class="text-capitalize">
                            <button type="button" class="btn btn-purple"><a href="{{ route('estado.show', $carrito_total['id_pedido']) }}" class="text-decoration-none text-white">Cambiar estado</a></button> 
                        </td>
                    </tr>
                @endforeach
            </tbody>
